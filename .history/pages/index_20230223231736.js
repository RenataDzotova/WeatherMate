...
export default function Home() {
  ...
  const fetchWeather = async () => {
    ...
    let weatherData = response.data.list.map((weather, index)=>{
      ...
      if (num !== arrayOfDays.find(element => element === num)) {
        ...
        return(
          <div key={index} style={{width:"200px", display:'flex', flexDirection:'column', justifyContent:'center', alignItems:'center', backgroundColor:'rgb(19 113 166 / 29%)', margin:'10px', borderRadius:'18px', border:'2px solid #ffffff69'}}>
            <Image
            src={icon}
            alt={icon}
            width={180}
            ...
            priority
            />
            <div style={{textAlign:'center', fontSize:'50px', fontWeight:'bold', color: 'white'}}>{weather.main.temp.toFixed(1)}°</div>
            <div style={{textAlign:'center', fontSize:'20px', color: 'white'}}>{weather.weather[0].main}</div>
  ...
  return (
    <>
      ...
      <main style={{width:"100vw", minHeight:'100vh', display:"flex", flexDirection: "column", justifyContent:'center', alignItems:'center'}}>
          <div>
          <Image 
        ...
        <div>
          <div style={{textAlign:'center', fontSize:'60px', fontWeight:'bold', color: 'white', marginTop:'10px'}}>
          Vancouver
          </div>
        ...
        <div style={{display:"flex", flexDirection:"row", flexWrap:"wrap", justifyContent:'center', marginTop:'50px'}}>
          {data}
        </div>
