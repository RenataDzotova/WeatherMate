  ...
  const fetchWeather = async () => {
    ...
    let weatherData = response.data.list.map((weather, index)=>{
      ...
      if (num !== arrayOfDays.find(element => element === num)) {
        ...
        return(
          <div key={index} style={{width:"200px", display:'flex', flexDirection:'column', justifyContent:'center', alignItems:'center', backgroundColor:'#1371a680', margin:'10px', borderRadius:'15px'}}>
            <Image
            src={icon}
            alt={icon}
            width={180}
