  ...
  const fetchWeather = async () => {
    ...
    let weatherData = response.data.list.map((weather, index)=>{
      ...
      if (num !== arrayOfDays.find(element => element === num)) {
        ...
        return(
          <div key={index} style={{width:"200px", display:'flex', flexDirection:'column', justifyContent:'center', alignItems:'center', backgroundColor:'rgb(19 113 166 / 29%)', margin:'10px', borderRadius:'18px', border:'2px solid white'}}>
            <Image
            src={icon}
            alt={icon}
            width={180}
